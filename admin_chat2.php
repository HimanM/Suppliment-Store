...
<head>
    ...
    <link rel="stylesheet" href="CSS/admin_chat_styles2.css">
    <script src="JS/admin_chat2.js" defer></script>
</head>
<body>
                        ...
                        <ul class="list-unstyled chat-list mt-2 mb-0">
                            <?php foreach ($users as $user): ?>
                                <li class="clearfix">
                                    ...
                                    <div class="about">
                                        <div class="user-link name" data-user-id="<?= $user['id'] ?>" data-username="<?= $user['username'] ?>"><?= $user['username'] ?></div>                                   
                                    </div>
                                </li>
                            <?php endforeach; ?>
                        </ul>
